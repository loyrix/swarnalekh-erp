...
abstract class AppLocalizations {
  ...
  /// No description provided for @billingCustomerWalkIn.
  ///
  /// In en, this message translates to:
  /// **'Walk-in Customer'**
  String get billingCustomerWalkIn;

  /// No description provided for @billingCustomerExisting.
  ///
  /// In en, this message translates to:
  /// **'Existing Customer'**
  String get billingCustomerExisting;

  /// No description provided for @billingCustomerNew.
  ///
  /// In en, this message translates to:
  /// **'New Customer'**
  String get billingCustomerNew;

  /// No description provided for @billingSearchCustomer.
  ///
  /// In en, this message translates to:
  /// **'Search and select customer'**
  String get billingSearchCustomer;

  /// No description provided for @billingWalkInNote.
  ///
  /// In en, this message translates to:
  /// **'This bill will be recorded for a walk-in customer.'**
  String get billingWalkInNote;

  /// No description provided for @billingNoSavedCustomers.
  ///
  /// In en, this message translates to:
  /// **'No saved customers yet.'**
  String get billingNoSavedCustomers;

  /// No description provided for @billingTotalPurchases.
  ///
  /// In en, this message translates to:
  /// **'Total Purchases'**
  String get billingTotalPurchases;
  ...
  /// No description provided for @billingLastVisit.
  ///
  /// In en, this message translates to:
  /// **'Last visit'**
  String get billingLastVisit;

  /// No description provided for @billingBillsUnit.
  ///
  /// In en, this message translates to:
  /// **'Bills'**
  String get billingBillsUnit;

  /// No description provided for @billingTagLabel.
  ///
  /// In en, this message translates to:
  /// **'Tag'**
  String get billingTagLabel;

  /// No description provided for @billingHuid.
  ///
  /// In en, this message translates to:
  /// **'HUID'**
  String get billingHuid;

  /// No description provided for @billingPcs.
  ///
  /// In en, this message translates to:
  /// **'Pcs'**
  String get billingPcs;

  /// No description provided for @billingClearAll.
  ///
  /// In en, this message translates to:
  /// **'Clear All'**
  String get billingClearAll;

  /// No description provided for @billingEditItems.
  ///
  /// In en, this message translates to:
  /// **'Edit Items'**
  String get billingEditItems;

  /// No description provided for @billingSelectedItems.
  ///
  /// In en, this message translates to:
  /// **'Selected Items'**
  String get billingSelectedItems;

  /// No description provided for @billingTotalItems.
  ///
  /// In en, this message translates to:
  /// **'Total Items'**
  String get billingTotalItems;

  /// No description provided for @billingTotalWeight.
  ///
  /// In en, this message translates to:
  /// **'Total Weight'**
  String get billingTotalWeight;

  /// No description provided for @billingMetalValue.
  ///
  /// In en, this message translates to:
  /// **'Metal Value'**
  String get billingMetalValue;
  ...
  /// No description provided for @billingGoldRate.
  ///
  /// In en, this message translates to:
  /// **'Gold Rate'**
  String get billingGoldRate;

  /// No description provided for @billingPerGram.
  ///
  /// In en, this message translates to:
  /// **'/g'**
  String get billingPerGram;

  /// No description provided for @billingPaymentDetails.
  ///
  /// In en, this message translates to:
  /// **'Payment Details'**
  String get billingPaymentDetails;

  /// No description provided for @billingAutoGenerated.
  ///
  /// In en, this message translates to:
  /// **'Auto-generated on save'**
  String get billingAutoGenerated;
  ...
  /// No description provided for @billingSecure.
  ///
  /// In en, this message translates to:
  /// **'Secure'**
  String get billingSecure;

  /// No description provided for @billingDataSafe.
  ///
  /// In en, this message translates to:
  /// **'Your data is safe'**
  String get billingDataSafe;

  /// No description provided for @billingAutoRate.
  ///
  /// In en, this message translates to:
  /// **'Auto'**
  String get billingAutoRate;

  /// No description provided for @billingTapToSet.
  ///
  /// In en, this message translates to:
  /// **'Tap to set'**
  String get billingTapToSet;

  /// No description provided for @billingEditValue.
  ///
  /// In en, this message translates to:
  /// **'Edit value'**
  String get billingEditValue;
